...
func TestFilter_Command3(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			input:       "<|START_THINKING|>This is a rainbow <co>emoji: 🌈</co: 0:[1]><|END_THINKING|>\n<|START_RESPONSE|>foo <co>bar</co: 0:[1,2],1:[3,4]><|END_RESPONSE|>",
			want: []melody.FilterOutput{
				{IsToolsReason: true, Text: "This", Logprobs: melody.TokenIDsWithLogProb{TokenIDs: []uint32{4184}, Logprobs: []float32{0.001}}},
				{IsToolsReason: true, Text: " is", Logprobs: melody.TokenIDsWithLogProb{TokenIDs: []uint32{1801}, Logprobs: []float32{0.002}}},
				{IsToolsReason: true, Text: " a", Logprobs: melody.TokenIDsWithLogProb{TokenIDs: []uint32{1671}, Logprobs: []float32{0.003}}},
				{IsToolsReason: true, Text: " rainbow", Logprobs: melody.TokenIDsWithLogProb{TokenIDs: []uint32{84470}, Logprobs: []float32{0.004}}},
				{IsToolsReason: true, Text: " ", Logprobs: melody.TokenIDsWithLogProb{TokenIDs: []uint32{37}, Logprobs: []float32{0.007}}},
