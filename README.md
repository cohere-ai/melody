...
[]FilterOutput{
    ...
    {IsToolsReason: true, Citations: []FilterCitation{{
        ...
        EndIndex:   26,
        Text:       "emoji: 🌈",
        DocIndices: []DocIndex{{ToolCallIndex: 0, ToolResultIndices: []int{1}}},
        IsThinking: true,
    }}},
    ...
    {Citations: []FilterCitation{{
        ...
        EndIndex:   7,
        Text:       "bar",
        DocIndices: []DocIndex{{ToolCallIndex: 0, ToolResultIndices: []int{1, 2}}, {ToolCallIndex: 1, ToolResultIndices: []int{3, 4}}},
        IsThinking: false,
    }}},
},
 */
