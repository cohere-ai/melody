...
def get_cmd3_v2_tests() -> list[tuple[str, str, str]]:
    ...
    merged_template = "templates/archive/cmd3-reasoning/cmd3-reasoning@1.jinja"
...
def get_cmd3_v1_tests() -> list[tuple[str, str, str]]:
    # get all .json files from the test_dir
    merged_template = "templates/archive/cmd3-legacy/cmd3-legacy@1.jinja"
...
def get_cmd3_v3_tests() -> list[tuple[str, str, str]]:
    # get all .json files from the test_dir
    merged_template = (
        "templates/archive/cmd3-default-thinking/cmd3-default-thinking@1.jinja"
    )
