...
class PyFilterOptions:
    ...
    def with_document_ids(self, document_ids: list[list[str]]) -> PyFilterOptions: ...
...
def render_cmd3_detailed(config: dict) -> RenderOutput: ...
def render_cmd4_detailed(config: dict) -> RenderOutput: ...
