	...
	tests := []struct {
	...
	}{
		{
			...
			wantCitations: []FilterCitation{
				...
				},
				{
					StartIndex: 52,
					EndIndex:   59,
					Sources:    []Source{{ToolCallIndex: 0, ToolResultIndices: []int{1, 2}}},
					Text:       "digest.",
				},
			},
		},
		...
		},
		{
			...
			wantFilterOutput: []FilterOutput{
				...
				{
					Citations: []FilterCitation{{StartIndex: 0, EndIndex: 3, Text: "foo", Sources: []Source{{ToolCallIndex: 0, ToolResultIndices: []int{0}}}}},
				},
			},
		},
		{
			...
			wantCitations: []FilterCitation{
				{
					...
					EndIndex:   3,
					Text:       "foo",
					Sources:    []Source{{ToolCallIndex: 0, ToolResultIndices: []int{0, 1, 2, 3, 4}}},
				},
			},
		},
		{
			...
			wantCitations: []FilterCitation{
				{
					...
					EndIndex:   7,
					Text:       "bar",
					Sources:    []Source{{ToolCallIndex: 0, ToolResultIndices: []int{1, 0}}},
				},
			},
		},
		{
			...
			wantCitations: []FilterCitation{
				{
					...
					EndIndex:   7,
					Text:       "bar",
					Sources:    []Source{{ToolCallIndex: 0, ToolResultIndices: []int{999}}},
				},
			},
		},
		{
