...
type Tokenizer interface {
	Encode(text string, opts ...EncodeOption) ([]int64, error)
	...
	EncodeBatch(texts []string, opts ...EncodeOption) ([][]int64, error)
	EncodeBatchUint32(texts []string, opts ...EncodeOption) ([][]uint32, error)
	DecodeBatch(tokens [][]int64, skipSpecialTokens bool) ([]string, error)
