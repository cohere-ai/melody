...
extern void melody_filter_options_cofl_decode_xml_text(CFilterOptions* options, bool enabled);
extern void melody_filter_options_cofl_nested_xml(CFilterOptions* options, bool enabled);
